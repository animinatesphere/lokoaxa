  ...
  return (
    <DashboardLayout>
      <div className="flex flex-col gap-8 pb-12">
        ...
        <div>
          <h2 className="text-lg font-bold text-gray-900 mb-6">Trending Now</h2>
        ...
        {/* Best Deals Section */}
        <div>
          <h2 className="text-lg font-bold text-gray-900 mb-6">Best Deals For You</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6">
            {mockProducts.map((product) => (
              <ProductCard key={product.id} product={product} />
            ))}
        ...
        {/* Recommended Section */}
        <div>
          <h2 className="text-lg font-bold text-gray-900 mb-6">Recommended For You</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6">
            {mockProducts.map((product) => (
              <ProductCard key={product.id} product={product} />
            ))}
