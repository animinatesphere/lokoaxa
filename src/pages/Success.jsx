  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white font-sans">
      <div className="max-w-md w-full px-6 flex flex-col items-center text-center">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-4">Successful</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full">
          <Link
            to="/orders"
            className="flex-1 py-3 px-4 border border-gray-300 rounded-xl font-medium text-gray-600 hover:bg-gray-50 transition-colors flex items-center justify-center gap-2"
          >
            <svg
              width="20"
              height="20"
          ...
          <button
            ...
            className="flex-1 py-3 px-4 bg-[#B000FF] text-white rounded-xl font-medium hover:bg-purple-700 transition-colors flex items-center justify-center gap-2"
          >
            <svg
              width="20"
              height="20"
