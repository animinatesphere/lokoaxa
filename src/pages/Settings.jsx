...
const Settings = () => {
  ...
  const SettingItem = ({ icon: Icon, title, subtitle, value, onChange, type = 'toggle' }) => (
    <div className="flex items-center justify-between py-4 px-6 border-b border-gray-100 last:border-b-0">
      <div className="flex items-center gap-4 flex-1">
        <div className="p-2 bg-purple-100 rounded-lg">
          <Icon size={20} className="text-[#B000FF]" />
        </div>
        <div>
      ...
      <div className="flex flex-col gap-8 pb-12">
          ...
          <div className="max-w-2xl space-y-6">
            ...
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
              <div className="p-6 bg-gray-50 border-b border-gray-200">
                <h3 className="font-semibold text-gray-900 text-xs uppercase tracking-wide">Appearance</h3>
              </div>
              <SettingItem
                icon={Moon}
                title="Dark mode"
            ...
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
              <div className="p-6 bg-gray-50 border-b border-gray-200">
                <h3 className="font-semibold text-gray-900 text-xs uppercase tracking-wide">Preferences</h3>
              </div>
              <SettingItem
                icon={Globe}
                title="Language"
            ...
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
              <div className="p-6 bg-gray-50 border-b border-gray-200">
                <h3 className="font-semibold text-gray-900 text-xs uppercase tracking-wide">Account</h3>
              </div>
              <SettingItem
                icon={Lock}
              ...
              <div className="flex items-center justify-between py-4 px-6">
                <div className="flex items-center gap-4 flex-1">
                  ...
                  <div>
                    <h3 className="text-gray-900 font-medium">Connected devices</h3>
                    <p className="text-gray-500 text-sm">2 active sessions</p>
                  </div>
                </div>
                <span className="bg-purple-100 text-[#B000FF] text-xs font-semibold px-3 py-1 rounded-full">2</span>
              </div>
            </div>
          </div>
        )}
        ...
        {activeTab === 'notifications' && (
          <div className="max-w-2xl space-y-6">
            ...
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
              <div className="p-6 bg-gray-50 border-b border-gray-200">
                <h3 className="font-semibold text-gray-900 text-xs uppercase tracking-wide">Channels</h3>
              </div>
              <SettingItem
                icon={Bell}
            ...
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
              <div className="p-6 bg-gray-50 border-b border-gray-200">
                <h3 className="font-semibold text-gray-900 text-xs uppercase tracking-wide">Activity</h3>
              </div>
              <SettingItem
                icon={Package}
                title="Order updates"
          ...
          <div className="max-w-2xl space-y-6">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="font-semibold text-gray-900 text-xs uppercase tracking-wide">Privacy Score</h3>
                <span className="text-[#B000FF] text-2xl font-bold">83/100</span>
              </div>
              <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
                <div className="h-full w-[83%] bg-[#B000FF] rounded-full"></div>
              </div>
              <p className="text-gray-500 text-sm mt-2">Your data protection health</p>
            </div>

            {/* Data Sharing */}
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
              <div className="p-6 bg-gray-50 border-b border-gray-200">
                <h3 className="font-semibold text-gray-900 text-xs uppercase tracking-wide">Data Sharing</h3>
              </div>
              <SettingItem
                icon={Globe}
            ...
            {/* Data You've Shared */}
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              <h3 className="font-semibold text-gray-900 text-xs uppercase tracking-wide mb-4">Data You've Shared</h3>
              <div className="flex flex-wrap gap-2">
                {['Browsing history', 'Purchase history', 'Location', 'Device info', 'Social profile', 'Style preferences'].map((tag) => (
                  <span key={tag} className="px-4 py-2 border border-[#B000FF] text-[#B000FF] rounded-full text-sm font-medium">
                    {tag}
                  </span>
                ))}
              </div>
            ...
            <div className="bg-white rounded-xl border border-red-200 p-6">
              <h3 className="font-semibold text-gray-900 text-xs uppercase tracking-wide mb-4">Danger Zone</h3>
              <div className="space-y-3">
                <div className="flex items-center justify-between py-3 border-b border-gray-200">
                  <div>
                    <h4 className="text-gray-900 font-medium">Download my data</h4>
                    <p className="text-gray-500 text-sm">Export a copy of all your data</p>
                  </div>
                ...
                <div className="flex items-center justify-between py-3">
                  <div>
                    <h4 className="text-gray-900 font-medium">Delete account</h4>
                    <p className="text-gray-500 text-sm">Permanently remove all your data</p>
                  </div>
        ...
        {activeTab === 'billing' && (
          <div className="max-w-2xl space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
              <div className="p-6 bg-gray-50 border-b border-gray-200">
                <h3 className="font-semibold text-gray-900 text-xs uppercase tracking-wide">Your Plan</h3>
              </div>
              <div className="p-6 space-y-4">
                ...
                <div className="flex items-center justify-between p-6 border-2 border-[#B000FF] rounded-2xl bg-purple-50/30">
                  <div>
                    ...
                    <p className="text-[#B000FF] font-bold text-lg">$0<span className="text-sm font-normal text-gray-500">/mo</span></p>
                  </div>
                ...
                <div className="flex items-center justify-between p-6 border border-gray-200 rounded-2xl hover:border-[#B000FF] transition-colors cursor-pointer">
                  <div>
                    ...
                    <p className="text-[#B000FF] font-bold text-lg">$9<span className="text-sm font-normal text-gray-500">/mo</span></p>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-6 border border-gray-200 rounded-2xl hover:border-[#B000FF] transition-colors cursor-pointer">
                  <div>
                    ...
                    <p className="text-[#B000FF] font-bold text-lg">$19<span className="text-sm font-normal text-gray-500">/mo</span></p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
              <div className="p-6 bg-gray-50 border-b border-gray-200">
                <h3 className="font-semibold text-gray-900 text-xs uppercase tracking-wide">Payment Methods</h3>
              </div>
              <div className="p-6 space-y-4">
                {/* Visa Card */}
                <div className="flex items-center justify-between p-4 border border-gray-200 rounded-xl">
                  <div className="flex items-center gap-3 flex-1">
                    ...
                    <div>
                      <p className="text-gray-900 font-medium text-sm">•••• •••• •••• 4242</p>
                ...
                <div className="flex items-center justify-between p-4 border border-gray-200 rounded-xl">
                  <div className="flex items-center gap-3 flex-1">
                    ...
                    <div>
                      <p className="text-gray-900 font-medium text-sm">•••• •••• •••• 8801</p>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6">
              <div className="flex justify-between items-center mb-6">
                <h3 className="font-semibold text-gray-900 text-xs uppercase tracking-wide">Billing Cycle</h3>
                <span className="text-[#B000FF] text-sm font-semibold">15th</span>
              </div>
              <div className="space-y-4">
                <p className="text-gray-600 text-xs uppercase tracking-wide font-medium">Billing date</p>
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-gray-500 text-xs font-medium">30th</span>
                </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
              <div className="p-6 bg-gray-50 border-b border-gray-200">
                <h3 className="font-semibold text-gray-900 text-xs uppercase tracking-wide">Auto-Renew & Receipts</h3>
              </div>
              <SettingItem
                icon={CreditCard}
            ...
            <div className="bg-gray-700 rounded-2xl overflow-hidden p-8">
              <div className="flex items-center justify-between">
                <div className="text-white">
                  ...
                  <p className="text-gray-300 text-sm mt-1">Experience the full Luxe ecosystem.</p>
                </div>
