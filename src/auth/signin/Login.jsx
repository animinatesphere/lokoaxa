  ...
  return (
    <div className="min-h-screen flex font-sans bg-white">
      ...
      <div className="relative w-1/2 hidden md:flex flex-col overflow-hidden rounded-br-[3rem] ">
        {/* Background image */}
        <div className="absolute inset-0 bg-cover bg-center me" />
        {/* Dark overlay */}
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white border border-[#A9A9B4] rounded-2xl shadow-sm px-10 py-10">
            ...
            <button
              ...
              className="w-full py-3 rounded-lg text-[#FFFFFF] text-sm font-semibold tracking-wide transition hover:opacity-90 active:scale-[0.98] bg-[#BD00FF] urbanist"
            >
              Continue
            </button>
            ...
            <p className="text-center text-sm text-[#000000] mt-5 inter font-medium">
              ...
              <a href="/signup" className="text-[#BD00FF] inter font-medium">
                Sign up
              </a>
            </p>
          </div>
